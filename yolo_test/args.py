...
class Args(object):
    ...
    parser.add_argument('--image_dir', default="../data_/dest_images/findobama/twopeople.jpeg", help='Directory to image')
    ...
    parser.add_argument('--detector', type=str, default='yolo', help='Detection model: mtcnn, retinaface')
